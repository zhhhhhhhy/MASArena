...
#     for dataset in datasets_to_download.values():
#         os.makedirs(dataset["extract_path"], exist_ok=True)

#     download(required_datasets=["datasets", "results", "initial_rounds"], if_first_download=True)
