...
class SwarmAgent:
    ...
    def __init__(self, agent_id: str, model_name: str = None, system_prompt: str = None):
        ...
        self.system_prompt = system_prompt or "You are an intelligent AI assistant specialized in solving problems carefully and step by step."
        self.llm = ChatOpenAI(
...
"""
        ...
        messages = [
            {"role": "system", "content": "You are an expert aggregator that analyzes multiple solutions and determines the most accurate one."},
...
class SwarmSystem(AgentSystem):
    ...
    def evaluate(self, problem: Dict[str, Any], **kwargs) -> Dict[str, Any]:
        ...
        return {
            ...
            "agent_solutions": [
                {"agent_id": s["agent_id"], "solution": s["solution"]}
