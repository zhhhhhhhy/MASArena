...
<body>
    <div class="container">
        <div class="header">
            <h1>{title}</h1>
            <p>Agent System: {agent_system} | Benchmark: {benchmark_name} | Generated: {datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')}</p>
        </div>
        ...
        <div class="summary-stats">
            <div class="stat-card">
                ...
                <div class="stat-subtitle">{correct} correct out of {total_problems} problems</div>
            </div>
            <div class="stat-card">
                <div class="stat-title">Total Duration</div>
                <div class="stat-value">{total_duration_ms/1000:.2f}s</div>
                <div class="stat-subtitle">Average: {avg_duration_ms/1000:.2f}s per problem</div>
            </div>
            <div class="stat-card">
                <div class="stat-title">Token Usage</div>
                <div class="stat-value">{total_tokens:,}</div>
                <div class="stat-subtitle">Average: {avg_tokens:.1f} tokens per problem</div>
            </div>
            <div class="stat-card">
        ...
        <div class="footer">
            Generated by Multi-Agent System Benchmark Visualizer | {datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')}
        </div>
    </div>
    ...
    function createProblemsList() {{
        ...
        resultsData.forEach(problem => {{
            const isCorrect = problem.score === 1;
            ...
            correctnessBadge.className = `badge ${{isCorrect ? 'badge-success' : 'badge-danger'}}`;
