...
class Autogen(AgentSystem):
    def __init__(self, name: str = "autogen", config: Dict[str, Any] = None):
        ...
        self.model_name = self.config.get("model_name") or os.getenv(
        ...
        for msg in messages:
            ...
            if msg.models_usage:
                ...
                usage_metadata = CompletionUsage(
                    ...
                    total_tokens=msg.models_usage.prompt_tokens
    ...
    async def run_agent(self, problem: Dict[str, Any], **kwargs) -> Dict[str, Any]:
        ...
        self.model_client = OpenAIChatCompletionClient(
            model=self.model_name, api_key=api_key, base_url=base_url
        )
        ...
        print(all_messages)
        return {"messages": all_messages, "final_answer": final_answer}
